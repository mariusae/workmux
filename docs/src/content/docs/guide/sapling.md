...
By default, Sapling worktrees are sibling EdenFS mounts. For a main checkout at
`/data/users/me/fbsource`, `workmux add my-task` creates
`/data/users/me/fbsource-my-task`. An explicit `worktree_dir` configuration
